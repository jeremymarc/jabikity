package com.unikity.jabikityx.protocol.muc
{
	 ...
	 */
	public class MUCUserItem extends XmppChunk implements IXmppChunk
	{
		public static const ELEMENT:String = "item";
		public static const NS:Namespace = MUCUser.NS;
		...
		override public function deserialize(object:Object):void
		{
			...
			// Child nodes
			if (xml.ns::actor.@jid.length() > 0) this.actor = xml.ns::actor.@jid;
			if (xml.ns::reason.length() > 0) this.reason = xml.ns::reason.valueOf();	
		}
		...
		override public function serialize():Object
		{
			...
			// Child nodes
			if (actor) xml.ns::actor.@jid = actor;
			if (reason) xml.ns::reason = reason;
